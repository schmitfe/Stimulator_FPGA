...
HD_PWD='C:/Users/felix/Desktop/VHDL/Stimulator_FPGA/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Stimulator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Stimulator.tcl -notrace
