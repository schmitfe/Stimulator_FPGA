...
HD_PWD='C:/Users/felix/Desktop/VHDL/Stimulator_FPGA/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Stimulator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Stimulator.tcl
