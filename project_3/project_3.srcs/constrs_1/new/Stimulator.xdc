...
#set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports ChanAddr2] io28
#set_property -dict {PACKAGE_PIN R10 IOSTANDARD LVCMOS33} [get_ports ChanAddr3] io29
...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { Write[1] }]; #IO_L15P_T2_DQS_RDWR_B_14 	Sch=ck_io[34]
set_property -dict { PACKAGE_PIN N16   IOSTANDARD LVCMOS33 } [get_ports { Write[2] }]; #IO_L11N_T1_SRCC_14 			Sch=ck_io[35]
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { ChanAddr2 }]; #IO_L8P_T1_D11_14 			Sch=ck_io[36]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { ChanAddr3 }]; #IO_L17P_T2_A14_D30_14 		Sch=ck_io[37]
