...
## LEDs
#set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports SS1]
#set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports SS2]
...
#set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports SCLK[0]]
#set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports MOSI[0]]
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { ja[3] }]; #IO_L6P_T0_15 Sch=ja[4]
#set_property -dict {PACKAGE_PIN D13 IOSTANDARD LVCMOS33} [get_ports SS[1]]
#set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports SCLK[1]]
#set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports MOSI[1]]
...
#set_property -dict { PACKAGE_PIN E6    IOSTANDARD LVCMOS33 } [get_ports { MOSI[0] }]; #IO_L5P_T0_AD13P_35	Sch=ad_p[13]	ChipKit pin=A8
...
connect_debug_port u_ila_0/probe0 [get_nets [list {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[0]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[1]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[2]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[3]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[4]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[5]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[6]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[7]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[8]} {ChannelArray[0].ChannelX/MemArray[0].MemoryX/WRCNT_loc[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 10 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[0]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[1]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[2]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[3]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[4]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[5]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[6]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[7]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[8]} {ChannelArray[0].ChannelX/MemArray[1].MemoryX/WRCNT_loc[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 10 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[0]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[1]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[2]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[3]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[4]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[5]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[6]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[7]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[8]} {ChannelArray[1].ChannelX/MemArray[1].MemoryX/WRCNT_loc[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 10 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[0]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[1]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[2]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[3]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[4]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[5]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[6]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[7]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[8]} {ChannelArray[1].ChannelX/MemArray[0].MemoryX/WRCNT_loc[9]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list {ChanAddr2_IBUF[0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe5]
set_property port_width 1 [get_debug_ports u_ila_0/probe5]
connect_debug_port u_ila_0/probe5 [get_nets [list {ChanAddr3_IBUF[0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe6]
set_property port_width 1 [get_debug_ports u_ila_0/probe6]
connect_debug_port u_ila_0/probe6 [get_nets [list {ChanAddr_IBUF[0]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe7]
set_property port_width 1 [get_debug_ports u_ila_0/probe7]
connect_debug_port u_ila_0/probe7 [get_nets [list {ChanAddressReg[0]_i_1_n_0}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe8]
set_property port_width 1 [get_debug_ports u_ila_0/probe8]
connect_debug_port u_ila_0/probe8 [get_nets [list ChanAddressReg]]
